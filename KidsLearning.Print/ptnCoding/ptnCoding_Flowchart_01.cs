        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (SOP == "1")
            {
                ...
                for (int i = 1; i <= 2; i++)
                {
                    ...
                    int b = RandomNumberGenerator.GetInt32(1, 100);
                    string s = (RandomNumberGenerator.GetInt32(1, 1000) > 500) ? "+" : "x";
            ...
            else if (SOP == "2")
            {
                ...
                int a = RandomNumberGenerator.GetInt32(1, 100);
                int b = RandomNumberGenerator.GetInt32(1, 100);
                int c = RandomNumberGenerator.GetInt32(1, 10000);
                if (c > 5000)
                {
            ...
            else if (SOP == "3")
            {
                ...
                {
                    a = RandomNumberGenerator.GetInt32(5, 20);
                    b = RandomNumberGenerator.GetInt32(5, 10);
