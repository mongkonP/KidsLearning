        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                else if(Leval == 1)
                {
                    ...
                    e.Graphics.DrawString($"นาฬิกาบอกเวลา {RandomNumberGenerator.GetInt32(0, 12)}:{RandomNumberGenerator.GetInt32(0, 60)}", fontDetail, new SolidBrush(Color.Black), xC + 200, yC + 50);
                }
                else if(Leval == 2)
                {
                    e.Graphics.DrawClock(xC, yC);

                    e.Graphics.DrawString($"นาฬิกาบอกเวลา {RandomNumberGenerator.GetInt32(0, 12)}:{RandomNumberGenerator.GetInt32(0, 60)}:{RandomNumberGenerator.GetInt32(0, 60)}", fontDetail, new SolidBrush(Color.Black), xC + 200, yC + 50);
                }
