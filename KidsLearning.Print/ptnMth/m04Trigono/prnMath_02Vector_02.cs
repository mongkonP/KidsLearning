  ...
  public partial  class prnMath_02Vector_02 : prnControl
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            ReportToppic = "กำหนดจุด และ ลาดเส้น บนแกน x,y";
            iPage = 1;
            iPageAll = 1;
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                e.Graphics.DrawString($"กำหนดจุด A=({RandomNumberGenerator.GetInt32(-10, 10)},{RandomNumberGenerator.GetInt32(-10, 10)}) และ" +
                                      $"B=({RandomNumberGenerator.GetInt32(-10, 10)},{RandomNumberGenerator.GetInt32(-10, 10)})"
                ...
                yC += 450;
                e.Graphics.DrawString($"เส้นตรง AB มีความยาว ___________ เซนติเมตร "
                                     , fontDetail, new SolidBrush(Color.Black), xC, yC);
