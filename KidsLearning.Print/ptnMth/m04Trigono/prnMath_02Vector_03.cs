  ...
  public partial  class prnMath_02Vector_03 : prnControl
    {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                int a = RandomNumberGenerator.GetInt32(-10, 10);
                int b = RandomNumberGenerator.GetInt32(-10, 10);
                int c = RandomNumberGenerator.GetInt32(-10, 10);
                int d = RandomNumberGenerator.GetInt32(-10, 10);
                int _e = RandomNumberGenerator.GetInt32(-10, 10);
                int f = RandomNumberGenerator.GetInt32(-10, 10);
                ...
                yC += 450;
                int p = RandomNumberGenerator.GetInt32(0, 3000);
                string strA;
                switch (p)
                {
                    case > 2000: strA = "ABC"; break;
                    case <= 2000 and >1000: strA = "BCA"; break;
                    case <=1000: strA = "BAC"; break;
                }
