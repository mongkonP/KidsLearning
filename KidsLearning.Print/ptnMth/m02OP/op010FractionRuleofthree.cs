  ...
  public partial  class op010FractionRuleofthree:prnControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            // groupBox2
            // 
            this.groupBox2.Size = new System.Drawing.Size(1182, 676);
            // 
            // printPreviewControl1
            // 
            this.printPreviewControl1.Size = new System.Drawing.Size(1176, 654);
            // 
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                int b = a * RandomNumberGenerator.GetInt32(1, 5);
                int _e = RandomNumberGenerator.GetInt32(1, 5);
                int d = _e * b;
                int c = a * _e;
                string _a = "", _b = "", _c = "", _d = "";
                int f = RandomNumberGenerator.GetInt32(1, 1000);
                if (f <= 250)
                {
