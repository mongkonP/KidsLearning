        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (int i = 1; i <= 3; i ++)
            {
                ...
                for (int z = 0; z <= 1; z++)
                {
                    if (rd_1.Checked)
                    {
                        a = RandomNumberGenerator.GetInt32(2, 50);
                        b = RandomNumberGenerator.GetInt32(1, 9);


                    }
                    else if (rd_2.Checked)
                    {
                        a = RandomNumberGenerator.GetInt32(10, 1000);
                        b = RandomNumberGenerator.GetInt32(10, 99);

                    }
                    else if (rd_3.Checked)
                    {
                        a = RandomNumberGenerator.GetInt32(100, 1000);
                        b = RandomNumberGenerator.GetInt32(100, 999);
                    }
