...
{
  public partial  class op010FractionPlusMinus_02Num : prnControl
    {
        public op010FractionPlusMinus_02Num()
        {
            InitializeComponent();
        ...
        private void InitializeComponent()
        {
            ...
            // bntPrint
            // 
            this.bntPrint.Location = new System.Drawing.Point(20, 567);
            // 
            // label2
            // 
            this.label2.Location = new System.Drawing.Point(178, 528);
            // 
            // txtPageCount
            // 
            this.txtPageCount.Location = new System.Drawing.Point(88, 525);
            // 
            // label1
            // 
            ...
            this.panel1.Size = new System.Drawing.Size(282, 236);
            this.panel1.TabIndex = 14;
            // 
            // rd_10
            // 
            this.rd_10.AutoSize = true;
            this.rd_10.Font = new System.Drawing.Font("Segoe UI", 18F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point);
            this.rd_10.Location = new System.Drawing.Point(19, 134);
            ...
            this.rd_10.CheckedChanged += new System.EventHandler(this.rd_1_CheckedChanged);
            // 
            // rd_9
            // 
            this.rd_9.AutoSize = true;
            this.rd_9.Font = new System.Drawing.Font("Segoe UI", 18F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point);
            this.rd_9.Location = new System.Drawing.Point(21, 94);
            this.rd_9.Name = "rd_9";
            ...
            this.rd_9.CheckedChanged += new System.EventHandler(this.rd_1_CheckedChanged);
            // 
            // rd_3
            // 
            ...
            this.panel3.Size = new System.Drawing.Size(282, 211);
            ...
            this.rd_8.Location = new System.Drawing.Point(21, 130);
            this.rd_8.Name = "rd_8";
            ...
            this.rd_6.Location = new System.Drawing.Point(19, 172);
            this.rd_6.Name = "rd_6";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                {
                    _den_1 = RandomNumberGenerator.GetInt32(4, 10);
                    do {
                        _den_2 = RandomNumberGenerator.GetInt32(2, 10);
                    } while (_den_1 == _den_2);

                }
                else if (Den == "E_Int")//แบบมีจำนวนเต็ม
                {
                ...
                else if (Den == "E_Flc")//แบบมีจำนวนคละ
                {
                    ...
                    _den_1 = RandomNumberGenerator.GetInt32(5, 10);
                    _den_2 = RandomNumberGenerator.GetInt32(5, 10);
                    _ext_1 = RandomNumberGenerator.GetInt32(0, 10);
                    _ext_2 = RandomNumberGenerator.GetInt32(0, 10);
                    /*int aa = RandomNumberGenerator.GetInt32(1, 3000) ;
                    if (aa > 2000)
                    {
                ...
                if (Sop == "+-x÷")
                {
                    ...
                    int aa = RandomNumberGenerator.GetInt32(1, 4000);
                    switch (aa)
                    {
                        case int n when n > 3000:
                            _sop = "+";
                ...
                if (_sop == "-")
                {
                  ...
                  //  MessageBox.Show($"{_a} + {_den_1}*{_ext_1} = {v_a}"  + "\n" + $"{_b} + {_den_2}*{_ext_2} = {v_b}" );
                    ...
                    {
                        b += (b == 1) ? 1 : RandomNumberGenerator.GetInt32(1, b);
                    }
