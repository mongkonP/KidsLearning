  ...
  public partial  class num005NumSortNumber:prnControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.groupBox1.Size = new System.Drawing.Size(492, 558);
            ...
            this.groupBox2.Size = new System.Drawing.Size(813, 558);
            // 
            // printPreviewControl1
            // 
            this.printPreviewControl1.Size = new System.Drawing.Size(807, 536);
            // 
            // numberSelect1
            // 
            ...
            // 
            // prnMath_005NumSortNumber
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(7F, 15F);
            this.Name = "prnMath_005NumSortNumber";
            this.Size = new System.Drawing.Size(1305, 558);
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (int i = 0; i < 7; i++)
            {
                ...
                /* int _a = (maxValue<=10)?10:RandomNumberGenerator.GetInt32(minValue, maxValue);
                 int _b = (maxValue <= 10) ? 10 : Convert.ToInt32(_a * 0.5);

                 numCount = RandomNumberGenerator.GetInt32(3, 10);
                 numString = "";
                 ...
                 {
                     numString += "  " + RandomNumberGenerator.GetInt32(b,  a).ToString("N0");
                 }
                ...
                {
                    string r;
                    do { r = RandomNumberGenerator.GetInt32(b, a).ToString("N0"); } while (numString.Contains(r));
                    numString += "  " + r;
                }
                ...
                {
                    _str = ((RandomNumberGenerator.GetInt32(1, 2000) < 1000) ? "น้อยไปมาก" : "มากไปน้อย");
                }
