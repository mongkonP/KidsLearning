  ...
  public partial  class num009Fraction_02NumberConvert : prnControl
    {
        ...
        private void rd_1_CheckedChanged(object sender, EventArgs e)
        {
            if (rd_1.Checked)
            {
                OP = "1"; ReportToppic = "เขียนเศษส่วนต่อไปนี้ ให้อยู่ในรูปเศษส่วนอย่างต่ำ พร้อมแสดงวิธีทำ";
            }
            else if (rd_2.Checked)
            {
                OP = "2"; ReportToppic = "เขียนเศษส่วนต่อไปนี้ ให้อยู่ในรูปจำนวนคละ  พร้อมแสดงวิธีทำ";
            }
            else if (rd_3.Checked)
            {
                OP = "3"; ReportToppic = "เขียนจำนวนคละต่อไปนี้ ให้อยู่ในรูปเศษส่วน  พร้อมแสดงวิธีทำ";
            }
            printPreviewControl1.Document = this.printDocument1;
        }
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (int i = 1; i <= 6; i++)
            {
                ...
                if (OP == "1")
                {
                    ...
                    c = RandomNumberGenerator.GetInt32(2, 10);
                     a = RandomNumberGenerator.GetInt32(1, 10) * c;
                     b = RandomNumberGenerator.GetInt32(2, 10) * c;
                ...
                else if (OP == "2")
                {
                     ...
                     a = RandomNumberGenerator.GetInt32(3, 10);
                     b = RandomNumberGenerator.GetInt32(1, 10);
                     c = RandomNumberGenerator.GetInt32(1, a - 1);
                    int d = a * b + c;
                ...
                else if (OP == "3")
                {
                    ...
                    e.Graphics.DrawString(" = ", new Font("Angsana New", 20), new SolidBrush(Color.Black), xC + 120, yC + 20);
                    e.Graphics.DrawFraction(d, d, a, xC + 10, yC, false, false, false); 
