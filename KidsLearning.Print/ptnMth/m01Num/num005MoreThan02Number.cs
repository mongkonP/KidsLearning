  ...
  public partial  class num005MoreThan02Number:prnControl
    {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (int i = 1; i <=8 ; i++)
            {
                ...
                e.Graphics.DrawMorethanLess(fontDetail, RandomNumberGenerator.GetInt32(minValue, maxValue), RandomNumberGenerator.GetInt32(minValue, maxValue), 250, yC);

                e.Graphics.DrawMorethanLess(fontDetail, RandomNumberGenerator.GetInt32(minValue, maxValue), RandomNumberGenerator.GetInt32(minValue, maxValue), 500, yC);
