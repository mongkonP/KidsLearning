...
namespace KidsLearning.Control.ThaiControl
{
        ...
        public void RandomChoie()
        {
            ...
            using (frmWaitFormDialog f = new frmWaitFormDialog(new Action(() =>
            {
               ...
               List<string> s; int i;
                ...
                do
                {
                    i = RandomNumber.Randomnumber(0, ck.Choies.Count );
                ...
                countAns =0 ;
                for (int b = 1; b <= RandomNumber.Randomnumber(5, 10) ; b++)
                {
                    
                    Button btn = this.Controls.Find("button" +  RandomNumber.Randomnumber(1, 16), true).FirstOrDefault() as Button;
                    if (btn.Text == "")
                    { 
                ...
                for (int b = 1; b <= 16; b++)
                {
                    ...
                    if (btn.Text == "")
                    {
                        btn.Invoke(new Action(() => { btn.Text = s[ RandomNumber.Randomnumber(0, s.Count)]; }));
