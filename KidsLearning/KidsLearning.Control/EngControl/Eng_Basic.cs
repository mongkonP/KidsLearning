      ...
      public Eng_Basic()
      {
        ...
        void RandomChoie()
        {
            ...
            using (frmWaitFormDialog f = new frmWaitFormDialog(new Action(() =>
            {
                ...
                Ans_file = wordFile[ RandomNumber.Randomnumber(0, wordFile.Count )];
                ...
                {
                    System.Threading.Thread.Sleep(100);
                    str = System.IO.Path.GetFileNameWithoutExtension(lstc[ RandomNumber.Randomnumber(0, lstc.Count )]);
