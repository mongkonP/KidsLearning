    ...
    private bool HaveGuideline;
        ...
        protected void PrintFromEquation_AddSub_1PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                string s =KidsLearning.Classed.Exten.Ext_Maths.Equation_AddSub(minValue, maxValue, operatorSelect1);
                ...
                e.Graphics.DrawRectangle(new Pen(Color.Black,2), xC + 15+ e.Graphics.MeasureString(s, fontDetail).Width, yC-3, w, h);
                 ...
                 s = KidsLearning.Classed.Exten.Ext_Maths.Equation_AddSub(minValue, maxValue, operatorSelect1);
        ...
        string GetPEMDAS_1()
        {
            string op = lstOP_1[RandomNumber.Randomnumber(0, lstOP_1.Count)];
            int a = RandomNumber.Randomnumber(1, 10);
            int b = RandomNumber.Randomnumber(1, 10);
            int c = RandomNumber.Randomnumber(1, 10);
            int d = b * c;
            string str = "";
            if (op == "+_x")
            {
        ...
        string GetPEMDAS_2()
        {
            string op = lstOP_2[RandomNumber.Randomnumber(0, lstOP_2.Count)];
            int a = RandomNumber.Randomnumber(1, 10);
            int b = RandomNumber.Randomnumber(1, 10);
            int c = RandomNumber.Randomnumber(1, 10);
            int d = b * c;
