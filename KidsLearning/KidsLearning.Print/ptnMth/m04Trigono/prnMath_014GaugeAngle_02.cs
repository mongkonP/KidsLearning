...
{
  public partial  class prnMath_014GaugeAngle_02:prnControl
    {
        public prnMath_014GaugeAngle_02()
        {
            InitializeComponent();
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            ReportToppic = "ลากเส้นตามมุม ต่อไปนี้ และทำลูกศรทิศทาง";
            iPage = 1;
            iPageAll = 1;
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // prnMath_90GaugeAngle_02
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(7F, 15F);
            this.Name = "prnMath_90GaugeAngle_02";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                e.Graphics.DrawString($"มุม {RandomNumber.Randomnumber(30, 170)} องศา ", fontDetail, new SolidBrush(Color.Black), xC + 500, yC - 50);
