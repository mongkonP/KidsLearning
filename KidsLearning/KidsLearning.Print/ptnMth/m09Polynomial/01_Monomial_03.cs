...
{
    public partial class _01_Monomial_03 : prnControl
    {
        public _01_Monomial_03()
        {
            InitializeComponent();
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            ReportToppic = "ให้เติมข้อมูลในช่องว่าง";
            iPage = 1;
            iPageAll = 1;
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString($"สัมประสิทธิ์", fontDetail, new SolidBrush(Color.Black), xC + 200, yC + 5);
            e.Graphics.DrawString($"ตัวแปร", fontDetail, new SolidBrush(Color.Black), xC + 320, yC + 5);
            ...
            for (int row = 0; row < 15; row++)
            {
                ...
                e.Graphics.DrawRectangle(new Pen(Color.Black, 2), new Rectangle(xC + 200, yC, 100, h));
                e.Graphics.DrawRectangle(new Pen(Color.Black, 2), new Rectangle(xC + 300, yC, 100, h));
                e.Graphics.DrawRectangle(new Pen(Color.Black, 2), new Rectangle(xC + 400, yC, 100, h));
                e.Graphics.DrawRectangle(new Pen(Color.Black, 2), new Rectangle(xC + 500, yC, 200, h));
                if (row > 0)
                {
                  //  string expression = TORServices.Maths.Expression.GenerateExpression();
