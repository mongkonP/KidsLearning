...
{
  public partial  class prnMath_013Money_ChangeSentence:prnControl
    {
        public prnMath_013Money_ChangeSentence()
        {
            InitializeComponent();
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            ReportToppic = "ให้ตอบคำถาม ต่อไปนี้";
            iPage = 1;
            iPageAll = 1;
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // prnMath_013Money_ChangeSentence
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
            this.Name = "prnMath_013Money_ChangeSentence";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                for (int cc = 0; cc <= cAll; cc++)
                {
                    ...
                    _return += s + _mc + " ชาม ";
                    string smc;
                    try { smc = new Regex(@"(\d+)", RegexOptions.Compiled).Match(s).Value.Trim(); }
                    catch { smc = ""; }
                    if (smc != "")
                ...
                _return += $"  เมื่อ {name} จ่ายเงิน " + payAll[RandomNumber.Randomnumber(0, payAll.Count)] + " บาท แม่ค้าต้องทอนเงินเท่าไหร่ ?";
                ...
                e.Graphics.DrawString(" - ", fontDetail, new SolidBrush(Color.Black), xC + 200, yC + 20);
                e.Graphics.DrawRectangle(new Pen(Color.Black, 1), new Rectangle(xC + 220, yC + 20, 100, 30));
                e.Graphics.DrawString(" = ", fontDetail, new SolidBrush(Color.Black), xC + 330, yC + 20);
                e.Graphics.DrawRectangle(new Pen(Color.Black, 1), new Rectangle(xC + 350, yC + 20, 100, 30));
                yC += 60;
