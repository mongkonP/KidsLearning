...
{
   public partial class num011SignificantFigure02 : prnControl
    {

        public num011SignificantFigure02()
        {
            InitializeComponent();
        }
        private void InitializeComponent()
        {
            ...
            // 
            // num011SignificantFigure02
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(7F, 15F);
            this.Name = "num011SignificantFigure02";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                int bb = RandomNumber.Randomnumber(0, 5);
                string num = aa.ToString("N" + bb);
               int cc = (num.Replace(".", "").Replace("-", "").Length==2)?1:RandomNumber.Randomnumber(1, num.Replace(".","").Replace("-","").Length-1);
