...
{
    public partial class num05_PowerbyTen_02 : prnControl
    {

        public num05_PowerbyTen_02()
        {
            InitializeComponent();
        }
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                sss = $"{(10 + "^" + RandomNumber.Randomnumber(-25, 25)).ToSuperscriptNumber()}" +
                    $"{_a}{(10 + "^" + RandomNumber.Randomnumber(-25, 25)).ToSuperscriptNumber()}" +
                    $"{_b}{(10 + "^" + RandomNumber.Randomnumber(-25, 25)).ToSuperscriptNumber()}" +
                    $"{_c}{(10 + "^" + RandomNumber.Randomnumber(-25, 25)).ToSuperscriptNumber()}" +
                    $"= ?" +
