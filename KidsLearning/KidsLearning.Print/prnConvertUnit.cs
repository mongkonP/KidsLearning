    ...
    public  class prnConvertUnit:prnClass
    {
        ...
        protected override void printDocument_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            for (int i = 0; i < 15; i++)
            {
                ...
                {
                    e.Graphics.DrawString(_prefix[RandomNumber.Randomnumber(0, _prefix.Count)] + " " + _unit[RandomNumber.Randomnumber(0, _unit.Count )], fontHeader, Brushes.Black, 130, yC + 20);
                }
